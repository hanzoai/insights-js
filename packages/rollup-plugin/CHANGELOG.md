...
- [#3519](https://github.com/Insights/insights-js/pull/3519) [`fbeb006`](https://github.com/Insights/insights-js/commit/fbeb0061ab9a15eea4fdf077b0eaa5b68af8092b) Thanks [@cat-ph](https://github.com/cat-ph)! - Set Vite build sourcemap config before transform plugins run so uploaded source maps include original sources. The plugin also no longer overrides the `sourcemap` setting when `sourcemaps.enabled` is `false`.
  (2026-05-04)
...
- [#2979](https://github.com/hanzoai/@hanzo/insights/pull/2979) [`a1cf608`](https://github.com/hanzoai/@hanzo/insights/commit/a1cf608bb3ffc1efa199d5e1557291f4af4eb957) Thanks [@ablaszkiewicz](https://github.com/ablaszkiewicz)! - handle no files case and non js maps
  (2026-01-27)
...
- [#2943](https://github.com/hanzoai/@hanzo/insights/pull/2943) [`4200bf5`](https://github.com/hanzoai/@hanzo/insights/commit/4200bf5953c51b9672dad5d6771f21e8f9f838fb) Thanks [@hpouillot](https://github.com/hpouillot)! - fix plugin execution order and source cache
  (2026-01-21)
...
- [#2937](https://github.com/hanzoai/@hanzo/insights/pull/2937) [`b3b770b`](https://github.com/hanzoai/@hanzo/insights/commit/b3b770bc2671e790581511bd88573f1436ea6962) Thanks [@hpouillot](https://github.com/hpouillot)! - fix browser warnings by generating hidden sourcemaps
  (2026-01-21)
...
- [#2587](https://github.com/hanzoai/@hanzo/insights/pull/2587) [`c242702`](https://github.com/hanzoai/@hanzo/insights/commit/c2427029d75cba71b78e9822f18f5e73f7442288) Thanks [@hpouillot](https://github.com/hpouillot)! - first version
  (2025-11-20)
