...
import { RRWebPluginCanvasWebRTCRecord } from '@insights/plugin-canvas-webrtc-record';
...
// Replay side
import rrweb from '@insights/rrweb';
import { RRWebPluginCanvasWebRTCReplay } from '@insights/plugin-canvas-webrtc-replay';
