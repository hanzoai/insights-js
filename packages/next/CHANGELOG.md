...
- Updated dependencies [[`3aff16e`](https://github.com/Insights/insights-js/commit/3aff16e98540e659be4158a784fe38ef755f878e)]:
    - @insights/react@1.10.0
...
- [#3549](https://github.com/Insights/insights-js/pull/3549) [`77ee9df`](https://github.com/Insights/insights-js/commit/77ee9df6a36dcc968516d1698d830b8368cf64ab) Thanks [@brandonhines-mialabs](https://github.com/brandonhines-mialabs)! - Fix `@insights/next/pages` default export condition to resolve to the client barrel (`pages.client.js`) instead of the server barrel (`pages.js`), matching the behavior of the root `"."` export. This prevents bundlers that don't match a more specific condition from pulling in `server-only` and `insights-node` unnecessarily.
  (2026-05-14)
...
- [#3608](https://github.com/Insights/insights-js/pull/3608) [`afb0ae8`](https://github.com/Insights/insights-js/commit/afb0ae8f1f8ddb901bc0963ca4d567f0ebf4353d) Thanks [@marandaneto](https://github.com/marandaneto)! - Fix Next.js pageview tracking to send absolute current URLs
  (2026-05-13)
...
- [#3543](https://github.com/Insights/insights-js/pull/3543) [`ece3097`](https://github.com/Insights/insights-js/commit/ece3097bea5d2cfeeaff0c02bb61e6f58c188013) Thanks [@dustinbyrne](https://github.com/dustinbyrne)! - Publish `@insights/next` from the release workflow so npm catches up with the versions already recorded in the changelog.
  (2026-05-07)
...
- [#3533](https://github.com/Insights/insights-js/pull/3533) [`eb546b4`](https://github.com/Insights/insights-js/commit/eb546b48bcc08d6e702e2eb30c8ae1005ea00739) Thanks [@brandonhines-mialabs](https://github.com/brandonhines-mialabs)! - Fix `@insights/next/pages` packaging so the documented Pages Router setup builds without a `server-only` import error.

    The `./pages` subpath previously had no per-runtime `exports` conditions, so any module importing from `@insights/next/pages` (e.g. `pages/_app.tsx`) transitively pulled in `'server-only'` and `insights-node`. Next.js rejects `'server-only'` from client modules before tree-shaking can drop the unused re-exports, breaking `next build`. The barrel is now split per runtime:
    - `browser` → `./dist/pages.client.js` — `InsightsProvider`, `InsightsPageView`
    - `edge-light` / `edge` / `worker` → `./dist/pages.edge.js` — `insightsMiddleware`, `InsightsPageView`, `DEFAULT_INGEST_PATH`
    - `react-server` / `default` → `./dist/pages.js` — full surface including `getServerSideInsights` and `getInsights`

    Existing imports (`from '@insights/next/pages'`) keep working unchanged; the resolver picks the right barrel per runtime. (2026-05-06)
...
- [#3428](https://github.com/Insights/insights-js/pull/3428) [`afc7655`](https://github.com/Insights/insights-js/commit/afc76553ae9de5973fc7d59738342bbb491dfb27) Thanks [@dustinbyrne](https://github.com/dustinbyrne)! - Fix native ESM module resolution in `@insights/next` so it can be imported from Vitest and other Node ESM environments.
  (2026-04-24)
...
- [#3376](https://github.com/Insights/insights-js/pull/3376) [`e8548a5`](https://github.com/Insights/insights-js/commit/e8548a58dd4f574d825c5750624b074f51eeae27) Thanks [@dustinbyrne](https://github.com/dustinbyrne)! - fix: pass bootstrap flags via React context so feature flag hooks return correct values during SSR
  (2026-04-15)
...
- [#3301](https://github.com/Insights/insights-js/pull/3301) [`bd4b0ac`](https://github.com/Insights/insights-js/commit/bd4b0acfb3b0d555fe25fc1af3860e778d2e08cb) Thanks [@dustinbyrne](https://github.com/dustinbyrne)! - Read Insights tracing headers (X-INSIGHTS-SESSION-ID, X-INSIGHTS-DISTINCT-ID, X-INSIGHTS-WINDOW-ID) in getInsights() and getServerSideInsights()
  (2026-04-02)
...
- [#3215](https://github.com/Insights/insights-js/pull/3215) [`429b389`](https://github.com/Insights/insights-js/commit/429b389a1f9d7d094ed682db29ad0d20e2889764) Thanks [@dustinbyrne](https://github.com/dustinbyrne)! - feat: rename `optOutByDefault` to `seedAnonymousCookie`
...
- [#3122](https://github.com/Insights/insights-js/pull/3122) [`706adb8`](https://github.com/Insights/insights-js/commit/706adb899ebe2139e2d68317e216bc1d2ff8af87) Thanks [@dustinbyrne](https://github.com/dustinbyrne)! - Initial release of @insights/next, a Insights integration with Next.js
  (2026-03-06)
