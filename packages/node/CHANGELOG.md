...
- [#3642](https://github.com/Insights/insights-js/pull/3642) [`18ea8b5`](https://github.com/Insights/insights-js/commit/18ea8b53f608607075c93bc18b29be8dfd41eb3f) Thanks [@dustinbyrne](https://github.com/dustinbyrne)! - Promote feature flag definition cache provider types to the main `insights-node` export and deprecate `insights-node/experimental` imports.
  (2026-05-21)
...
- [#3640](https://github.com/Insights/insights-js/pull/3640) [`12ef3f6`](https://github.com/Insights/insights-js/commit/12ef3f63d18831b8ceffe7e81cea07d0c8a392a7) Thanks [@hpouillot](https://github.com/hpouillot)! - Fix `identifyImmediate` to await the underlying network request. Previously the returned promise resolved before the `$identify` event was sent, causing events to be dropped when called from short-lived runtimes (Vercel/Cloudflare Workers, Convex actions) that exit immediately after `await`.
  (2026-05-21)
...
- [#3476](https://github.com/Insights/insights-js/pull/3476) [`f8bc02f`](https://github.com/Insights/insights-js/commit/f8bc02f946b51f27f55f97351ca8d81a1fa54e9d) Thanks [@dmarticus](https://github.com/dmarticus)! - Add `evaluateFlags()` and a new `flags` option on `capture()` so a single `/flags` request powers both flag branching and event enrichment per incoming request:
  ...
  Deprecates `isFeatureEnabled()`, `getFeatureFlag()`, `getFeatureFlagPayload()`, and `capture({ sendFeatureFlags })`. They continue to work but now log a deduped `[Insights] ... is deprecated` warning the first time they're used. Removal is planned for the next major version. (2026-05-02)
...
- [#3474](https://github.com/Insights/insights-js/pull/3474) [`70ba8f8`](https://github.com/Insights/insights-js/commit/70ba8f84649680a8c5e85b0deae00741075dc21b) Thanks [@patricio-insights](https://github.com/patricio-insights)! - feat(flags): support mixed targeting in local evaluation
  (2026-04-30)
...
- [#3491](https://github.com/Insights/insights-js/pull/3491) [`974e4b2`](https://github.com/Insights/insights-js/commit/974e4b273d36399e9491c88eb0a95aa23bca69b3) Thanks [@dustinbyrne](https://github.com/dustinbyrne)! - Add Express and NestJS request context support for Insights tracing headers.
  (2026-04-29)
...
- [#3457](https://github.com/Insights/insights-js/pull/3457) [`eadbcd7`](https://github.com/Insights/insights-js/commit/eadbcd7b15e48e6d04f7cac487df25db2f73e9a7) Thanks [@hpouillot](https://github.com/hpouillot)! - send relative file paths in frames
  (2026-04-23)
...
- [#3407](https://github.com/Insights/insights-js/pull/3407) [`b26c57c`](https://github.com/Insights/insights-js/commit/b26c57c31574c6e2fddcf6a98551421fe90b559d) Thanks [@patricio-insights](https://github.com/patricio-insights)! - fix(flags): switch local evaluation polling from `/api/feature_flag/local_evaluation` to `/flags/definitions`
  (2026-04-21)
...
- [#3282](https://github.com/Insights/insights-js/pull/3282) [`5784dca`](https://github.com/Insights/insights-js/commit/5784dcaeb71f7e67d9c9df28f116886a573d19df) Thanks [@marandaneto](https://github.com/marandaneto)! - fix: captureException now uses distinctId from request context
  (2026-03-26)
...
- [#3243](https://github.com/Insights/insights-js/pull/3243) [`697e423`](https://github.com/Insights/insights-js/commit/697e4237ca945caa33b26f35872951ad0e7530d4) Thanks [@hpouillot](https://github.com/hpouillot)! - fix captureExceptionImmediate return value
  (2026-03-18)
...
- [#3236](https://github.com/Insights/insights-js/pull/3236) [`bc30c2d`](https://github.com/Insights/insights-js/commit/bc30c2d988bb307e811d97711f208c125eefba3a) Thanks [@dustinbyrne](https://github.com/dustinbyrne)! - fix: Client shutdown awaits the feature flags poller to stop
  (2026-03-13)
...
- [#3197](https://github.com/Insights/insights-js/pull/3197) [`33e9fb4`](https://github.com/Insights/insights-js/commit/33e9fb4b3fae3676e10bdc2b0990e8ec229dd5be) Thanks [@hpouillot](https://github.com/hpouillot)! - Add nestjs integration with interceptor for context propagation
  (2026-03-05)
...
- [#3186](https://github.com/Insights/insights-js/pull/3186) [`4601bbc`](https://github.com/Insights/insights-js/commit/4601bbc3d8456ce36ea1065a44101415501d4729) Thanks [@dmarticus](https://github.com/dmarticus)! - Add semver comparison operators to local feature flag evaluation: semver_eq, semver_neq, semver_gt, semver_gte, semver_lt, semver_lte, semver_tilde, semver_caret, and semver_wildcard
  (2026-03-05)
...
- [#3187](https://github.com/Insights/insights-js/pull/3187) [`2eff595`](https://github.com/Insights/insights-js/commit/2eff595e137f2b430092ec4330a42261fb470764) Thanks [@dustinbyrne](https://github.com/dustinbyrne)! - feat: Accept a `waitUntil` method for serverless environments
  (2026-03-04)
