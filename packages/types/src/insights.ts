/**
 * Insights instance interface
 *
 * This interface describes the public API of the Insights class.
 * It can be used to type `window.hi` when loading Insights via a script tag.
 */
 ...
 *
 * This can be used to type `window.hi` when loading Insights via a `<script>` tag.
 *
 * @example
 * ```typescript
 * import type { Insights } from '@hanzo/insights-types'
 *
 * declare global {
 *     interface Window {
 *         insights?: Insights
 ...
 * }
 *
 * // Now you can use window.hi with type safety
 * window.hi?.capture('my_event', { property: 'value' })
 * ```
 */
export interface Insights {
    /**
     * The current configuration of the Insights instance.
     */
    ...
    /**
     * Whether the Insights instance has been loaded.
     */
    __loaded: boolean
     ...
     */
    init(token: string, config?: Partial<InsightsConfig>, name?: string): Insights
    ...
    featureFlags: {
         ...
         * insights.featureFlags.overrideFeatureFlags({
