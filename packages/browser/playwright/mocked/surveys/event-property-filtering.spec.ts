...
test.describe('surveys - event property filtering', () => {
    test('shows survey when event name matches without property filters', async ({ page, context }) => {
        ...
        await expect(page.locator('.InsightsSurvey-event-survey-1').locator('.survey-form')).not.toBeInViewport()

        // Trigger the event
        await page.evaluate(() => {
            ;(window as any).insights.capture('purchase_completed', {
        ...
        await expect(page.locator('.InsightsSurvey-event-survey-1').locator('.survey-form')).toBeVisible()
    })
    ...
    test('shows survey when event matches exact property filter', async ({ page, context }) => {
        ...
        // Survey should not be visible initially
        await expect(page.locator('.InsightsSurvey-exact-filter-survey').locator('.survey-form')).not.toBeInViewport()
        ...
        // Survey should now be visible
        await expect(page.locator('.InsightsSurvey-exact-filter-survey').locator('.survey-form')).toBeVisible()
    })
    ...
    test('shows survey when event matches is_not property filter', async ({ page, context }) => {
        ...
        await expect(page.locator('.InsightsSurvey-is-not-filter-survey').locator('.survey-form')).not.toBeInViewport()
        ...
        // Survey should now be visible
        await expect(page.locator('.InsightsSurvey-is-not-filter-survey').locator('.survey-form')).toBeVisible()
    })
    ...
    test('shows survey when event matches regex property filter', async ({ page, context }) => {
        ...
        await page.evaluate(() => {
            ;(window as any).insights.capture('page_view', {
                url: '/home',
            })
        })

        // Survey should not be visible
        await expect(page.locator('.InsightsSurvey-regex-filter-survey').locator('.survey-form')).not.toBeInViewport()
        ...
        // Survey should now be visible
        await expect(page.locator('.InsightsSurvey-regex-filter-survey').locator('.survey-form')).toBeVisible()
    })
    ...
    test('shows survey when event matches icontains property filter', async ({ page, context }) => {
        ...
        await page.evaluate(() => {
            ;(window as any).insights.capture('search_performed', {
        ...
        // Survey should not be visible
        await expect(
            page.locator('.InsightsSurvey-icontains-filter-survey').locator('.survey-form')
        ).not.toBeInViewport()
        ...
        // Survey should now be visible
        await expect(page.locator('.InsightsSurvey-icontains-filter-survey').locator('.survey-form')).toBeVisible()
    })
    ...
    test('shows survey when event matches multiple property filters (AND logic)', async ({ page, context }) => {
        ...
        // Survey should not be visible
        await expect(page.locator('.InsightsSurvey-multi-filter-survey').locator('.survey-form')).not.toBeInViewport()
        ...
        // Survey should now be visible
        await expect(page.locator('.InsightsSurvey-multi-filter-survey').locator('.survey-form')).toBeVisible()
    })
    ...
    test('does not show survey when required property is missing', async ({ page, context }) => {
        ...
        await page.evaluate(() => {
            ;(window as any).insights.capture('user_action', {
                other_field: 'some_value',
            })
        })

        // Survey should not be visible
        await expect(page.locator('.InsightsSurvey-missing-prop-survey').locator('.survey-form')).not.toBeInViewport()
    ...
    test('not_regex property filter works correctly', async ({ page, context }) => {
        ...
        // Survey should not be visible
        await expect(page.locator('.InsightsSurvey-not-regex-survey').locator('.survey-form')).not.toBeInViewport()
        ...
        // Survey should now be visible
        await expect(page.locator('.InsightsSurvey-not-regex-survey').locator('.survey-form')).toBeVisible()
    })
    ...
    test('not_icontains property filter works correctly', async ({ page, context }) => {
        ...
        // Survey should not be visible
        await expect(page.locator('.InsightsSurvey-not-icontains-survey').locator('.survey-form')).not.toBeInViewport()
        ...
        // Survey should now be visible
        await expect(page.locator('.InsightsSurvey-not-icontains-survey').locator('.survey-form')).toBeVisible()
    })
    ...
    test('survey captures correct events when triggered by property filters', async ({ page, context }) => {
        ...
        // Survey should not be visible initially
        await expect(page.locator('.InsightsSurvey-event-capture-survey').locator('.survey-form')).not.toBeInViewport()

        // Trigger the event that should activate the survey
        await page.evaluate(() => {
            ;(window as any).insights.capture('form_submitted', {
                form_type: 'contact',
                page: 'home',
            })
        })
        ...
        // Survey should now be visible
        await expect(page.locator('.InsightsSurvey-event-capture-survey').locator('.survey-form')).toBeVisible()

        // Verify survey shown event was captured
        await pollUntilEventCaptured(page, 'survey shown')

        // Fill out and submit the survey
        await page.locator('.InsightsSurvey-event-capture-survey textarea').type('Property filtering works great!')
        await page.locator('.InsightsSurvey-event-capture-survey .form-submit').click()
