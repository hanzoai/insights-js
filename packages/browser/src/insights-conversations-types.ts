...
/**
 * Remote configuration for conversations from the Insights server
 */
export interface ConversationsRemoteConfig {
    /**
     * Whether conversations are enabled for this team
     * When true, the conversations API is available (insights.conversations.*)
     */
    enabled: boolean
...
export interface SendMessagePayload {
    ...
    /**
     * Distinct ID for linking to Insights Person
     */
    distinct_id: string
