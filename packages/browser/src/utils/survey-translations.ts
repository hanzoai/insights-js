 ...
 * 2. person properties 'language' (allows programmatic control via insights.identify())
 ...
 * - Listen to config changes (once we add config change events to Insights core)
 * - Re-render survey when language changes mid-session
 *
 * @param instance - Insights instance to retrieve config and person properties
 ...
 * @param instance - Insights instance to retrieve person properties
