...
describe('insights-surveys', () => {
    describe('InsightsSurveys Class', () => {
        ...
        beforeEach(() => {
            ...
            surveys = new InsightsSurveys(mockInsights as Insights)

            // Mock window.__InsightsExtensions__
        ...
        afterEach(() => {
            // Clean up
            delete assignableWindow.__InsightsExtensions__
            localStorage.clear()
        })
        ...
        describe('canRenderSurvey', () => {
            ...
            it('should return visible: true if surveys are loaded and the survey is eligible', () => {
                mockInsights.get_property.mockReturnValue([survey])
                surveys['_surveyManager'] = new SurveyManager(mockInsights as Insights)
        ...
        describe('checkSurveyEligibility', () => {
            beforeEach(() => {
                ...
                mockInsights.get_property.mockReturnValue([
                    survey,
                    repeatableSurvey,
            ...
            it('cannot render completed surveys', () => {
                ...
                mockInsights.get_property.mockReturnValue([completedSurvey])
            ...
            describe('check order and interaction between multiple eligibility criteria', () => {
                ...
                beforeEach(() => {
                    mockInsights.get_property.mockReturnValue([surveyWithBothConditions])
                ...
                it('allows surveys that pass all checks including repeatability', () => {
                    ...
                    mockInsights.get_property.mockReturnValue([repeatableSurveyWithWaitPeriod])
        ...
        describe('loadIfEnabled', () => {
            ...
            it('should not initialize if surveys are disabled', () => {
                mockInsights.config.disable_surveys = true
                surveys.loadIfEnabled()
            ...
            it('should set isInitializingSurveys to false when loadExternalDependency fails', () => {
                ...
                assignableWindow.__InsightsExtensions__.generateSurveys = undefined
            ...
            it('should call the callback with the surveys when they are loaded', () => {
                ...
                mockInsights.get_property.mockReturnValue(mockSurveys)
            ...
            it('should call onSurveysLoaded callback with surveys even when generateSurveys triggers an async fetch', async () => {
                ...
                mockInsights.get_property.mockReturnValue(undefined)

                // Mock _send_request to simulate async API call
                mockInsights._send_request.mockImplementation(({ callback: reqCallback }) => {
                    setTimeout(() => {
            ...
            it('should not load surveys in cookieless mode without consent', () => {
                mockInsights.config.cookieless_mode = 'on_reject'
                const mockIsOptedOut = mockInsights.consent.isOptedOut as jest.Mock
        ...
        describe('getSurveys', () => {
            ...
            it('should reuse in-flight promise when fetch is in progress', async () => {
                ...
                mockInsights._send_request.mockImplementation(({ callback }) => {
                    setTimeout(() => {
                ...
                expect(mockInsights._send_request).toHaveBeenCalledTimes(1)
            ...
            it('should clear promise after successful API call', () => {
                ...
                expect(mockInsights.persistence?.register).toHaveBeenCalledWith({ [SURVEYS]: mockSurveys })
            })
            ...
            it('should handle delayed successful responses correctly', () => {
                ...
                expect(mockInsights.persistence?.register).toHaveBeenCalledWith({ [SURVEYS]: delayedSurveys })
            })
            ...
            it('should force reload surveys when forceReload is true', () => {
                ...
                expect(mockInsights._send_request).toHaveBeenCalled()
            })
        })
    })
})
