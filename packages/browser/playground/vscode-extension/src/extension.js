...
function getWebviewContent(context, webview) {
    const localScriptPath = vscode.Uri.joinPath(context.extensionUri, '..', '..', 'dist', 'array.full.js')
    const localScriptUri = webview.asWebviewUri(localScriptPath)

    const snippetSrc = runningLocally ? `'${localScriptUri}'` : 's.api_host+"/static/array.full.js"'
