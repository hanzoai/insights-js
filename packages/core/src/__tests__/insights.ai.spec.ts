...
describe('Insights Core', () => {
  ...
  describe('ai', () => {
    it('should capture feedback', async () => {
      ...
      insights.captureTraceFeedback('trace-id', 'feedback')
    ...
    it('should convert numeric traceId in captureTraceFeedback', async () => {
      ...
      insights.captureTraceFeedback(10, 'feedback')
    ...
    it('should capture a metric', async () => {
      ...
      insights.captureTraceMetric('trace-id', 'metric-name', 'good')
    ...
    it('should convert numeric arguments in captureTraceMetric', async () => {
      ...
      insights.captureTraceMetric(10, 'metric-name', 1)
