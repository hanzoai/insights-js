...
describe('Insights Core', () => {
  ...
  describe('setPersonPropertiesForFlags', () => {
    ...
    it('set_once properties skip keys that already exist in the cache', () => {
      insights.setPersonPropertiesForFlags({ $set_once: { first_date: '2025-01-01', plan: 'free' } })
      ...
      insights.setPersonPropertiesForFlags({ $set_once: { first_date: '2026-03-30', new_key: 'hello' } })
    ...
    it('set properties overwrite existing keys even when set_once does not', () => {
      insights.setPersonPropertiesForFlags({ $set_once: { first_date: '2025-01-01' } })
      ...
      insights.setPersonPropertiesForFlags({
