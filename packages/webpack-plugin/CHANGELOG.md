...
- [#3716](https://github.com/Insights/insights-js/pull/3716) [`3889f02`](https://github.com/Insights/insights-js/commit/3889f024e6e27c2ca8444cde95fb3df6eb8a9574) Thanks [@ablaszkiewicz](https://github.com/ablaszkiewicz)! - Default `sourcemaps.enabled` to `true`, matching the other Insights bundler plugins. Previously it defaulted to `NODE_ENV === 'production'`.
  (2026-06-02)
