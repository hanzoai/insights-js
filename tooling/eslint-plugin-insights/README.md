# Insights JS Custom ESLint rules 

This package contains custom ESLint rules for Insights's JS codebase.

For example, we have a number of functions that check types like `isNull` or `isBoolean`. 
In most projects these don't help very much but since @hanzo/insights is bundled and included in many different projects,
